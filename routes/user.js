...
const { storeUser, login, loginPage, membersPage, membersPostsPage, membersCategoriesPage, categoriesPost, categoriesDelete, registerPage, logoutAction } = require('../controller/user');
